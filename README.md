...
## :tada: 最近更新
* :fire: [2024-08-30] [**YuanChat V0.7 通用版本升级：知识库文件解析与检索能力全面升级** :point_right:](./docs/YuanChat通用版本V0.7.md)
* :fire: [2024-06-27] [**YuanChat V0.6 通用版本升级：支持256K文档长度输入** :point_right:](./docs/YuanChat通用版本V0.7.md)
